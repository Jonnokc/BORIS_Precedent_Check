Sub Precedence_Check()
  ...
  To_Review_Headers = Array("RAW_CODE_DISPLAY", "RAW_CODE_SYSTEM_NAME", "RAW_CODE_SYSTEM_ID", "Precdent Closest Match", "Precedent Raw Code System ID(s)", "Precdent Concept Alias", "MATCH_RESPONSE", "Precident Map Count", "Similarity")
  ...
  For i = 0 To UBound(To_Review_Headers)
    ...
    If Header_Check = False Then
      ...
      If To_Review_Headers(i) = To_Review_Headers(3) _
         Or To_Review_Headers(i) = To_Review_Headers(4) _
         Or To_Review_Headers(i) = To_Review_Headers(5) _
         Or To_Review_Headers(i) = To_Review_Headers(6) _
         Or To_Review_Headers(i) = To_Review_Headers(7) _
         Or To_Review_Headers(i) = To_Review_Headers(8) _
         Then
